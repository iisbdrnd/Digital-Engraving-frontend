                    ...
                    Cell: (row) => (
                        <div>
                            <span onClick={() => {
                                ...
                                <i className="fa fa-trash" style={{ width: 35, fontSize: 16, padding: 3, color: '#e4566e' }}
                                ></i>
                            </span>

                            <span><i className="fa fa-pencil" style={{ width: 35, fontSize: 16, padding: 3, color: 'rgb(40, 167, 69)' }}></i></span>
                        </div>
                    ),
                    style: {
                        textAlign: 'center'
