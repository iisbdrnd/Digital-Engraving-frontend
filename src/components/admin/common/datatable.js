...
import { adminDeleteMethod } from '../../../api/action'
...
export class Datatable extends Component {
    ...
    deleteHandler(itemId){
        ...
        let response = adminDeleteMethod(deleteLink, itemId)
            .then(response => {
    ...
    render() {
        const {pageSize, myClass, multiSelectOption, pagination, editLink, accessLink } = this.props;
                ...
                columns.push(
                    {
                        ...
                        Cell: (row) => (
                            <div>
                                <div>
                                    <span>
                                        <Link to={`${process.env.PUBLIC_URL}/${editLink}/${row.original.id}`} className="fa fa-pencil" style={{ width: 35, fontSize: 16, padding: 3, color: 'rgb(40, 167, 69)', cursor: "pointer" }}></Link>
                                    </span>
                                    <span onClick={() => {
                                        if (window.confirm('Are you sure you wish to delete this item?')) {
                                        ...
                                        <i className="fa fa-trash" style={{ width: 35, fontSize: 16, padding: 3, color: '#e4566e', cursor: 'pointer' }}
                                        ></i>
                                    </span>
                                </div>
                                {accessLink ? 
