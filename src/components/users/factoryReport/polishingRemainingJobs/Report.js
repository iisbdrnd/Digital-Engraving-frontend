...
import {POLISHING_REMAINING_JOBS_REPORT} from '../../../../api/userUrl'
...
const Report = (props) => {
    ...
    useEffect(()=>{
        userGetMethod(`${POLISHING_REMAINING_JOBS_REPORT}?fromDate=${fromDate}&&toDate=${toDate}`) 
        .then(response => {
                                ...
                                (
                                    <>
                                        <div className="text-center">
                                            <h5>{'Polishing Remaining Jobs - '+fromDate+' to '+toDate}</h5>
                                        </div>
                                        <Fragment>
                                            <div className="row">
