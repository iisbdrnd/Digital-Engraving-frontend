                                                    ...
                                                    <tbody>
                                                        {chromeSchedules.length > 0 ?
                                                            chromeSchedules.map((chromeSchedule)=>(    
                                                                <tr>    
                                                                    <td style={columnHead} className="text-left">{chromeSchedule.date}</td>
                                                                    <td style={columnHead} className="text-left">{chromeSchedule.job_no}</td>        
                                                                    <td style={columnHead} className="text-left">{chromeSchedule.job_name}</td>
                                                                    <td style={columnHead} className="text-left">{chromeSchedule.printer_name}</td>        
                                                                    <td style={columnHead} className="text-left">{chromeSchedule.fl}</td>
                                                                    <td style={columnHead} className="text-left">{chromeSchedule.cir}</td>        
                                                                    <td style={columnHead} className="text-left">{chromeSchedule.dia}</td>
                                                                    <td style={columnHead} className="text-left">{chromeSchedule.surface_area}</td>        
                                                                </tr>   
                                                            ))
                                                        : null
                                                        }
