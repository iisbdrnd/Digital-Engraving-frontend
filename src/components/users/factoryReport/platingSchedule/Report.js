...
import {PLATING_SCHEDULE_REPORT} from '../../../../api/userUrl'
...
const Report = (props) => {
    ...
    useEffect(()=>{
        userGetMethod(`${PLATING_SCHEDULE_REPORT}?fromDate=${fromDate}&&toDate=${toDate}`) 
        .then(response => {
                                ...
                                (
                                    <>
                                        <div className="text-center">
                                            <h5>{'Plating Schedule - '+fromDate+' to '+toDate}</h5>
                                        </div>
                                        <Fragment>
                                            <div className="row">
