...
export default function ListData(props) {
    ...
    const handlePageChange = (pageNumber = 1) => {
        setIsLoading(true);
        // TABLE DATA READY
        userGetMethod(`${chartOfAccountAPI}?page=${pageNumber}`)
            .then(response => {
                                        ...
                                        <table className="table table-border-horizontal">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" width="40%" onClick={() => sortHandler(2)} >
                                                        <i className="fa fa-sort"></i>Account Code</th>
                                                    <th scope="col" width="40%" onClick={() => sortHandler(3)} >
                                                        <i className="fa fa-sort"></i> Account Head</th>
