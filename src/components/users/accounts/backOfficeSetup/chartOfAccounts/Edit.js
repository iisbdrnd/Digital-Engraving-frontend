...
const Edit = (props) => {
    ...
    const chartOfAccountsId = props.match.params.chartOfAccountsId;
    ...
    useEffect(() => {
        userGetMethod(`${chartOfAccountAPI}/${chartOfAccountsId}/edit`)
            .then(response => {
                console.log(response);
                setInputValue(
                    (prevstate) => ({
                        ...prevstate,
                        main_code : response.data.chartOfAccounts.main_code,
                        account_head: response.data.chartOfAccounts.account_head,
                        account_code: response.data.chartOfAccounts.account_code,
                        general_code: response.data.chartOfAccounts.classified_code,
                        control_code: response.data.chartOfAccounts.control_code,
                        subsidiary_code: response.data.chartOfAccounts.subsidiary_code
                    })
                    );
                    setIsLoading(false);
                })
    ...
    const submitHandler = (data, e) => {
        if(submit){
            ...
            userPutMethod(`${chartOfAccountAPI}/${chartOfAccountsId}`, inputValue )
            .then(response => {
