...
import {ledgerQueryReportActionApi} from '../../../../../api/userUrl'
...
const Report = (props) => {
    ...
    const handlePageChange = (pageNumber = 1) => {
        ...
        if(type == 1){
            var url = `${ledgerQueryReportActionApi}?type=1&branch_id=${branch_id}&account=${account}&`;
        }else{
            var url = `${ledgerQueryReportActionApi}?type=2&branch_id=${branch_id}&account=${account}&from_date=${from_date}&to_date=${to_date}&`;
        }
        ...
        userGetMethod(`${url}?page=${pageNumber}`)
            .then(response => {
                ...
                setAccName(response.data.acc_name);
                ...
                <div className="row">
                    <div className="col-sm-12">
                        <div className="">
                            ...
                            <p className="text-center">Account Name: {accName}</p>
                                                        ...
                                                        <table className="particulars table table-bordered table-stripped" style={{"width" : "100%"}}>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                { Object.values(voucherData).map( (ledger, index) =>  
                                                                    (
                                                                        <>
                                                                        { (ledger.debit_amount == 0 && ledger.credit_amount == 0) ? "" : 
