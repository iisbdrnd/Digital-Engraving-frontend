...
import {BalanceSheetList} from '../../../../../api/userUrl'
...
const Form = (props) => {
    ...
    useEffect( () => {
        userGetMethod(`${BalanceSheetList}`)
        .then(response => {
    ...
    const submitHandler = (data, e) => {
        ...
        if(reportType == 'upto_date'){
            var url = `${process.env.PUBLIC_URL}/user/balance-sheet-report-action?type=1&branch_id=${branch_id}&level_id=${level_id}&`;
        ...
        if(reportType == 'date_range'){
            ...
            var url = `${process.env.PUBLIC_URL}/user/balance-sheet-report-action?type=2&branch_id=${branch_id}&level_id=${level_id}&from_date=${from_date}&to_date=${to_date}&`;
            window.open(url, '_blank', 'height=800,width=1200');
        }
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <form onSubmit={handleSubmit(submitHandler)} className="needs-validation theme-form">
                                        ...
                                        <div className="form-group row offset-sm-1">
                                            <label className="col-sm-4 col-form-label" htmlFor="level_id">Select Account Level</label>
                                            <div className="col-sm-4">
                                                <select 
                                                    name="level_id" 
                                                    id="level_id" 
                                                ...
                                                {errors.level_id && <p className='text-danger'>{errors.level_id.message}</p>}
