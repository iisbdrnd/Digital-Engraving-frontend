...
import { CANCEL_ORDER_RSURL, JOB_ORDER_DETAILS } from '../../../api/userUrl';
...
const Add = (props) => {
    ...
    useEffect(()=>{
        userGetMethod(`${CANCEL_ORDER_RSURL}/create?job_order_id=${job_order_id}`)
            .then(response => {
    ...
    const submitHandler = (data, e) => {
        ...
        userPostMethod(CANCEL_ORDER_RSURL, data)
            .then(response => {
                                ...
                                <form onSubmit={handleSubmit(submitHandler)} className="needs-validation theme-form">
                                    <div className="row">
                                        <div className="col-md-6" style={{marginTop: '20px'}}>
                                            ...
                                            <div className="form-group row">
                                                <label className="col-sm-3 col-form-label required" htmlFor="cancel_date">Cancel Date</label>
                                                <div className="col-sm-9">
                                                    <input className="form-control digits" id="cancel_date" name="cancel_date" readOnly={'readonly'} type="text" value={jobAgreementInput.cancel_date} ref={register({ required: true })} />
                                                    {errors.cancel_date && 'Cancel Date is required'}
                                                    <div className="valid-feedback">Looks good!</div>
                                                </div>
                                            </div>

                                            <div className="form-group row">
                                                <label className="col-sm-3 col-form-label" htmlFor="cancel_qty">Cancel Quantity</label>
                                                <div className="col-sm-9">
                                                    <input className="form-control" id="cancel_qty" name="cancel_qty" type="text" placeholder="Cancel Quantity" ref={register({})} />
                                                </div>
                                            </div>
                                            <div className="form-group row">
