                                                ...
                                                <table className="particulars table table-bordered table-stripped reportBody" cellSpacing="5" cellPadding="5" width="100%"  style={tableStyle}>
                                                    <thead>    
                                                        <tr>
                                                            ...
                                                            <th width= "8%" align="center" >New</th>
                                                            <th width= "8%" align="center" >Remake</th>
                                                            <th width= "8%" align="center" >Redo</th>
                                                            <th width= "8%" align="center" >DC/RC</th>
                                                            <th width= "8%" align="center" >Total Cyl</th>
                                                            <th width="12%" align="center" >Total S.A.</th>
                                                            <th width= "8%" align="center" >Billable Cyl</th>
                                                            <th width= "8%" align="center" >Billable S.A.</th>
                                                            <th width= "8%" align="center" >Cancel Qty</th>
                                                            ...
                                                            {grandTotals.length > 0 ? 
                                                                grandTotals.map((grandTotal, key)=>(
                                                                    <tr>  
                                                                        ...
                                                                        <th>{grandTotal.billable_surface_area}</th>  
