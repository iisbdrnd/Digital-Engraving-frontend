...
import {JOB_FLOW_ANALYSISS_MARKETING_PERSON_WISE_FORM} from '../../../../api/userUrl'
...
const Form = (props) => {
    ...
    useEffect(() => {
        userGetMethod(`${JOB_FLOW_ANALYSISS_MARKETING_PERSON_WISE_FORM}`)
        .then(response => {
    ...
    const submitHandler = (data, e) => {
        ...
        let url = `${process.env.PUBLIC_URL}/jobFlowAnalysisMarketingPersonWise/${data.from_date}/${data.to_date}/${data.employee_id ? data.employee_id : null}`;
                            ...
                            <div className="card-header">
                                <div className="row">
                                    <div className="col-md-6">
                                        <h5>Job Flow Analysis Marketing Person Wise</h5>
                                    </div>
                                </div>
                            </div>
