...
export default function ListData(props) {
    ...
    const searchHandler = (e) =>{
        setIsLoading(true);
        userGetMethod(`${jobSubClassAPI}?page=${1}&perPage=${perPage}&searchText=${searchText}`)
        .then(response => {
    ...
    const handlePageChange = (pageNumber = 1) => {
        setIsLoading(true);
        // TABLE DATA READY
        userGetMethod(`${jobSubClassAPI}?page=${pageNumber}&perPage=${perPage}&searchText=${searchText}`)
            .then(response => {
                                        ...
                                        <table className="table table-border-horizontal">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" width="40%" onClick={() => sortHandler(2)} >Job Class</th>
                                                    {/* <th scope="col" width="20%" onClick={() => sortHandler(3)} ><i className="fa fa-sort"></i> 
                                                    Label2</th> */}
                                                    <th scope="col" width="20%" onClick={() => sortHandler(3)} > 
                                                    Sub Class</th>
