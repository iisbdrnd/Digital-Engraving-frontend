...
const Edit = (props) => {
    ...
    const [userCustomMenuInput, setCustomMenuInput] = useReducer(
    ...
    const customMenuId = props.match.params.customMenuId;

    const changeHandler = (event) => {
        setCustomMenuInput({[event.target.name]: event.target.value});
    }

    useEffect(() => {
        userGetMethod(`${customMenuAPI}/${customMenuId}/edit`)
            .then(response => {
                console.log('response', response);
                setCustomMenuInput({
                    custom_menu_code : response.data.custom_menu.custom_menu_code,
                    custom_menu_name : response.data.custom_menu.custom_menu_name,
                    isLoading: false
                });
            })
    ...
    const submitHandler = (data) => {
        ...
        userPutMethod(`${customMenuAPI}/${customMenuId}`, data )
            .then(response => {
                    ...
                    <div className="col-sm-12">
                        ...
                        <div className="card">
                            <div className="card-header">
                                <h5>Update Custom Menu</h5>
                            </div>
                            <div className="card-body">
                                {userCustomMenuInput.isLoading ? (<img src={process.env.PUBLIC_URL+'/preloader.gif'} alt="Data Loading"/>):
                                (
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-4">
                                                <input 
                                                    ...
                                                    value={userCustomMenuInput.custom_menu_code}
                                                    ref={register({
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-4">
                                                <input 
                                                    ...
                                                    onChange={changeHandler}
                                                    value={userCustomMenuInput.custom_menu_name}
                                                    ref={register({
