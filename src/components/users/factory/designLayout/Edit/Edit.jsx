...
import { DESIGN_LAYOUT_RSURL,JOB_ORDER_DETAILS } from "../../../../../api/userUrl";
...
const Edit = (props) => {
    ...
    let job_order_id = props.match.params.job_no ? props.match.params.job_no : null;
    console.log(props);
    useEffect(() => {
                    ...
                    <div className="card-body">
                        <>
                            <form onSubmit={handleSubmit(onSubmit)} className="theme-form row">
                                ...
                                {isLayout == true ? (<EditLayout inputChangeHandler={inputChangeHandler} formData={formData}/>) : ("")
                                }
                                {isBase == true ? (<EditBase inputChangeHandler={inputChangeHandler} formData={formData} typeColorOptions = {typeColorOptions}/>) : ("")
                                }
