                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                ...
                                                <fieldset className="border p-2" >
                                                    ...
                                                    <div className="form-row">
                                                        <div className="col-md-8">
                                                            <label className="col-md-6 col-form-label label-form" style={mt10}>Chrome Cylinder? <input type="checkbox" /> Dai after Rough Cut</label>
                                                            <div className="col-md-5" style={mt10}>
                                                                <input type="text" className="form-control" name="cyls1" />
                                                            </div>
                                                        </div>

                                                        <div className="col-md-4">
                                                            <label className="col-md-6 col-form-label label-form" style={mt10}>Dai after Fine Cut</label>
                                                            <div className="col-md-6" style={mt10}>
                                                                <input type="text" className="form-control" name="cyls1" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="form-row">
                                                        <div className="col-md-6">
                                                            <div className="form-group">
                                                                <label className="col-md-5 col-form-label label-form" style={mt10}>A. off Time</label>
                                                                <div className="col-md-7" style={mt10}>
                                                                    <input type="text" className="form-control" name="cyls1" />
                                                                </div>
                                                            </div>
                                                            
                                                            {/* <div className="form-group">
                                                                <label className="col-md-5 col-form-label label-form" style={mt10}>Output Status</label>
                                                                <div className="col-md-7" style={mt10}>
                                                                    <select className="form-control">
                                                                        <option>select one</option>
                                                                    </select>
                                                        ...
                                                        <div className="col-md-6 pull-right">
                                                            <div className="form-group">
                                                                <label className="col-md-5 col-form-label label-form" style={mt10}>A. Duration</label>
                                                                <div className="col-md-5" style={mt10}>
                                                                    <input type="time" className="form-control" name="cyls1" />
                                                                </div>
                                                            ...
                                                            <div className="form-group">
                                                                <label className="col-md-5 col-form-label label-form" style={mt10}>Action if output is not OK</label>
                                                                <div className="col-md-7" style={mt10}>
                                                                    <input type="text" className="form-control" name="cyls1" />
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div className="col-md-12">
                                                        ...
                                                        <div className="col-md-10" style={mt10}>
                                                            <input type="text" className="form-control" name="cyls1" />
                                                        </div>
                                                    </div>                                          
