...
import {BASE_SUPPLY_SCHEDULE_FORM} from '../../../../api/userUrl'
...
const Form = (props) => {
    ...
    useEffect(() => {
        userGetMethod(`${BASE_SUPPLY_SCHEDULE_FORM}`)
        .then(response => {
    ...
    const submitHandler = (data, e) => {
        ...
        let url = `${process.env.PUBLIC_URL}/baseSupplySchedule/${data.from_date}/${data.to_date}/${data.client_id ? data.client_id : null}`;
