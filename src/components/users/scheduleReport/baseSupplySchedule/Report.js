...
import {BASE_SUPPLY_SCHEDULE_REPORT} from '../../../../api/userUrl'
...
const Report = (props) => {
    ...
    useEffect(()=>{
        userGetMethod(`${BASE_SUPPLY_SCHEDULE_REPORT}?fromDate=${fromDate}&&toDate=${toDate}&&clientId=${clientId}`) 
        .then(response => {
                                ...
                                (
                                    <>
                                        <div className="text-center">
                                            <h5>{'Base Supply Schedule - '+fromDate+' to '+toDate}</h5>
                                        </div>
                                        <Fragment>
                                            <div className="row">
                                                <table className="particulars table table-bordered table-stripped reportBody" cellSpacing="5" cellPadding="5" width="100%"  style={tableStyle}>
                                                    <thead>    
                                                        <tr>
                                                            ...
                                                            <th width="6%" align="center">Day Needed</th>
                                                            <th width="6%" align="center">Received Date</th>
                                                                        ...
                                                                        <>
                                                                            ...
                                                                            {client.jobs.map((job)=>( 
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{Math.round(Math.abs((new Date(job.delivery_date) - new Date(job.order_date)) / oneDay))}</td>
