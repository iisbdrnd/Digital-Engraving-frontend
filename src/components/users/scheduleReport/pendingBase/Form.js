...
import {PENDING_BASE_FORM} from '../../../../api/userUrl'
...
const Form = (props) => {
    ...
    useEffect(() => {
        userGetMethod(`${PENDING_BASE_FORM}`)
        .then(response => {
    ...
    const submitHandler = (data, e) => {
        ...
        let url = `${process.env.PUBLIC_URL}/pendingBase/${data.from_date}/${data.to_date}/${data.client_id ? data.client_id : null}`;
