...
import {CLIENT_STOCK_REPORT_FORM} from '../../../../api/userUrl'
...
const Form = (props) => {
    ...
    useEffect(() => {
        userGetMethod(`${CLIENT_STOCK_REPORT_FORM}`)
        .then(response => {
    ...
    const submitHandler = (data, e) => {
        ...
        let url = `${process.env.PUBLIC_URL}/clientStockReport/report/${data.client_id ? data.client_id : null}/${data.printer_id ? data.printer_id : null}`;
                            ...
                            <div className="card-header">
                                <div className="row">
                                    <div className="col-md-6">
                                        <h5>Client Stock Report Form</h5>
                                    </div>
                                </div>
                            </div>
