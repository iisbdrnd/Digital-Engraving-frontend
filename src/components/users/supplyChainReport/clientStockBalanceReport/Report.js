...
import {CLIENT_STOCK_BALANCE_REPORT} from '../../../../api/userUrl'
...
const Report = (props) => {
    ...
    useEffect(()=>{
        userGetMethod(`${CLIENT_STOCK_BALANCE_REPORT}?client_id=${client_id}&&printer_id=${printer_id}`) 
        .then(response => {
                                ...
                                (
                                    <>
                                        <div className="text-center">
                                            <h5>{'Client Stock Balance Report'}</h5>
                                        </div>
                                        <Fragment>
                                            <div className="row">
                                                <table className="particulars table table-bordered table-stripped reportBody" cellSpacing="5" cellPadding="5" width="100%"  style={tableStyle}>
                                                    <thead>    
                                                        <tr>
                                                            ...
                                                            <th width="6%" align="center">Max Receive Date</th>
                                                            ...
                                                            <th width="6%" align="center">Balance</th>
                                                        </tr>    
                                                    </thead>
                                                    <tbody>
                                                        {jobs.length > 0 ? 
