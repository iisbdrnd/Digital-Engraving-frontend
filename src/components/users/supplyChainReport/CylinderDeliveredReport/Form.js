...
import { CYLINDER_DELIVERED_FORM} from '../../../../api/userUrl'
...
const Form = (props) => {
    ...
    useEffect(() => {
        userGetMethod(`${CYLINDER_DELIVERED_FORM}`)
        .then(response => {
    ...
    const submitHandler = (data, e) => {
        ...
        let url = `${process.env.PUBLIC_URL}/cylinderDeliveredReport/${data.from_date}/${data.to_date}/${data.client_id ? data.client_id : null}`;
