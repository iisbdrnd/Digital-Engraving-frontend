...
import {CLIENT_WISE_BILL_INFO_FORM, JOB_FLOW_ANALYSISS_MARKETING_PERSON_WISE_FORM} from '../../../../api/userUrl'
...
const Form = (props) => {
    ...
    useEffect(() => {
        userGetMethod(`${CLIENT_WISE_BILL_INFO_FORM}`)
        .then(response => {
    ...
    const submitHandler = (data, e) => {
        ...
        let url = `${process.env.PUBLIC_URL}/clientWiseBillInformationReport/${data.from_date}/${data.to_date}/${data.client_id ? data.client_id : null}`;
                            ...
                            <div className="card-header">
                                <div className="row">
                                    <div className="col-md-6">
                                        <h5>Client Wise Bill Information Report Form</h5>
                                    </div>
                                </div>
                            </div>
