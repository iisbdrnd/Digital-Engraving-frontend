...
import {PRINTER_WISE_JOB_STATUS_DETAILS_FORM} from '../../../../api/userUrl'
...
const Form = (props) => {
    ...
    useEffect(() => {
        userGetMethod(`${PRINTER_WISE_JOB_STATUS_DETAILS_FORM}`)
        .then(response => {
    ...
    const submitHandler = (data, e) => {
        ...
        let url = `${process.env.PUBLIC_URL}/printerWiseJobStatusDetails/${data.from_date}/${data.to_date}/${data.printer_id ? data.printer_id : null}`;
                            ...
                            <div className="card-header">
                                <div className="row">
                                    <div className="col-md-6">
                                        <h5>Printer Wise Job Status Details</h5>
                                    </div>
                                </div>
                            </div>
