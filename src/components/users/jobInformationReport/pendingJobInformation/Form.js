...
import {PENDING_JOB_INFORMATION_FORM} from '../../../../api/userUrl'
...
const Form = (props) => {
    ...
    useEffect(() => {
        userGetMethod(`${PENDING_JOB_INFORMATION_FORM}`)
        .then(response => {
    ...
    const submitHandler = (data, e) => {
        ...
        let url = `${process.env.PUBLIC_URL}/pendingJobInformation/${data.from_date}/${data.to_date}/${data.employee_id ? data.employee_id : null}`;
