...
export const JOB_ORDER_SEARCH = 'api/user/searchJob';
export const GET_JOB_CLIENT_MARKETING = 'api/user/getClientMarketingPerson';
export const GET_JOB_CLIENT_ADDRESS = 'api/user/getClientAddress';
...
export const getTargetYear = 'api/user/getTargetYear';
export const postMonthlyTargetAPI = 'api/user/monthlyTarget';
...
export const CLIENT_WISE_ACCOUNT_STATEMENT_REPORT = 'api/user/clientWiseAccountStatementsReport';
...
export const PREVIOUS_BASE_TO_STOCK_REPORT = 'api/user/previousBaseToStockReport';
